...
parser.add_argument('--img_flist', type=str, default=r'F:\syq\RN-master\datasets\image.flist')
parser.add_argument('--mask_flist', type=str, default=r'F:\syq\RN-master\datasets\mask.flist')
...
parser.add_argument('--save_folder', default=r'F:\syq\RN-master\checkpoints', help='Location to save checkpoint models')
...
HG = hgut.generate_G_from_H(H)  # H-超边矩阵
...
def render(epoch, iter, mask, output, gt):
    ...
    io.imsave(name_pre+'gt.png', ((gt+1)*127).astype(np.uint8))
